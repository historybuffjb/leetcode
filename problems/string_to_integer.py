...
"""
Run DETAILS
Runtime: 36 ms, faster than 60.24% of Python3 online submissions for String to Integer (atoi).
Memory Usage: 14.5 MB, less than 28.29% of Python3 online submissions for String to Integer (atoi).
"""
